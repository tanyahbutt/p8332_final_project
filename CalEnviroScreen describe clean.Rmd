...
Note, census tracts are condensed in southern CA and therefore distributions in this region are not visible. We will work to refine these maps if used in the final project 
...
ggplot(dat_merge_sf) +
  geom_sf(aes(fill = PM2_5))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
  
ggplot(dat_merge_sf) +
  geom_sf(aes(fill = DieselPM))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
  
ggplot(dat_merge_sf) +
  geom_sf(aes(fill = Tox_Rel))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
...
ggplot(dat_merge_sf) +
  geom_sf(aes(fill = Uranium))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
  
ggplot(dat_merge_sf) +
  geom_sf(aes(fill = Cadmium))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
  
ggplot(dat_merge_sf) +
  geom_sf(aes(fill = Lead.y))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
  

ggplot(dat_merge_sf) +
  geom_sf(aes(fill = Cardiovas))+
  scale_fill_gradientn(colours=rev(magma(6)), trans="sqrt")
